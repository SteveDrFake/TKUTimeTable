...
function sampleState(){
  ...
  return [
    ...
    make("demo-04","線性代數","088",1,[5],"王教授","B 003"),
    make("demo-05","微積分","096",1,[6,7],"何教授","B 004"),
    make("demo-06","哲學概論","100",1,[6,7],"王教授","B 002"),
    ...
    make("demo-17","社團學習與實作－入門課程","096",3,[10],"鄒老師","C 001"),
